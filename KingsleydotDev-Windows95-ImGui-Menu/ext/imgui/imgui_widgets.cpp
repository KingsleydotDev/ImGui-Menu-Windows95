...
// Note how thickness == 1.0f is handled specifically as not moving CursorPos by 'thickness', but other values are. klngsley.dev
...
void ImGui::EndBoxSelect(const ImRect& scope_rect, ImGuiMultiSelectFlags ms_flags)
{
    ...
    if (enable_scroll)
    {
        ...
        //GetForegroundDrawList()->AddRect(scroll_r.Min, scroll_r.Max, IM_COL32(0, 255, 0, 255)); klngsley.dev
