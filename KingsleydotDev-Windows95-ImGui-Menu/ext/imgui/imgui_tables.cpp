...
void ImGui::TableUpdateLayout(ImGuiTable* table)
{
    ...
    for (int order_n = 0; order_n < table->ColumnsCount; order_n++)
    {
        ...
        // Non-resizable columns keep their requested width (apply user value regardless of IsPreserveWidthAuto) klngsley.dev
...
void ImGui::TableBeginCell(ImGuiTable* table, int column_n)
{
    ...
    // Start position is roughly ~~ CellRect.Min + CellPadding + Indent klngsley.dev
